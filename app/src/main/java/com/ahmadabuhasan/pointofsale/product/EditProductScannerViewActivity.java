...
public class EditProductScannerViewActivity extends BaseActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        EditProductActivity.etProductCode.setText(rawResult.getText());
        ...
        Dexter.withContext(this)
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                        ...
                        EditProductScannerViewActivity activity = EditProductScannerViewActivity.this;
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse permissionDeniedResponse) {
                        if (permissionDeniedResponse.isPermanentlyDenied()) {
                            Toasty.info(EditProductScannerViewActivity.this, R.string.camera_permission, Toasty.LENGTH_SHORT).show();
                        }
                    }
