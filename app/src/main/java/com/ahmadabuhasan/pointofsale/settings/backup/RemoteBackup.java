...
import static com.ahmadabuhasan.pointofsale.database.DatabaseOpenHelper.DATABASE_NAME;
import static com.ahmadabuhasan.pointofsale.settings.backup.BackupActivity.REQUEST_CODE_CREATION;
import static com.ahmadabuhasan.pointofsale.settings.backup.BackupActivity.REQUEST_CODE_OPENING;
import static com.ahmadabuhasan.pointofsale.settings.backup.BackupActivity.REQUEST_CODE_SIGN_IN;
...
public class RemoteBackup {
    ...
    private void startDriveBackup() {
        mDriveResourceClient
                ...
                .addOnFailureListener(
                        e -> Log.w(TAG, this.activity.getString(R.string.failed_to_create_new_contents), e));
    }
    ...
    private Task<Void> createFileIntentSender(DriveContents driveContents) {
        ...
        MetadataChangeSet metadataChangeSet = new MetadataChangeSet.Builder()
                .setTitle("PointOfSale_backup.db")
        ...
        openFileTask
                .continueWithTask(task -> {
                    ...
                    try {
                        ...
                        Toasty.success(this.activity, R.string.database_Import_completed, Toasty.LENGTH_SHORT).show();

                    } catch (Exception e) {
                        e.printStackTrace();
                        Toast.makeText(this.activity, R.string.failed, Toast.LENGTH_SHORT).show();
                    }
                ...
                .addOnFailureListener(e -> {
                    ...
                    Toast.makeText(this.activity, R.string.error_on_import, Toast.LENGTH_SHORT).show();
                });
    }
    ...
    private Task<DriveId> pickFile() {
        OpenFileActivityOptions openOptions =
                new OpenFileActivityOptions.Builder()
                        ...
                        .setActivityTitle(this.activity.getString(R.string.select_database_file))
                        .build();
